...
\begin{abstract}
    ...
    We perform a hypothesis test of the null hypothesis that the German Lotto numbers are sampled with equal probability,
    using the $\chi^2$ test statistic, with a p-value of \todo{the p-value}. 
